...
#define SECSPERDEGREE 14
#define INCHESPERSEC 355 
...
void MOTOR_Tasks ( void )
{
    ...
    switch ( motorsData.state )
    {
        ...
        { 
            ...
            sendThroughQueue(one, uartData.motorthread); // 4
            sendThroughQueue(two, uartData.motorthread); // 5
            sendThroughQueue(three, uartData.motorthread); // 6
            sendThroughQueue('R', uartData.motorthread); // 7
            sendThroughQueue('0', uartData.motorthread); // 8
            sendThroughQueue('0', uartData.motorthread); // 9
            sendThroughQueue('0', uartData.motorthread); // 10
